...
$(document).ready(function (e) {
    $.fn.stickyAudioPlayer = function (options) {
        ...
        var isRunning = false;
        var box, boxContainer, audioElement, btnPause, btnPlay, btnStop, textTile, barMain, barProgress, boxCover,
            textSong, boxData, proceedTo, btnVolume, btnMute, barVolume, barVolumeProgress, maxWidthBarVolume,
            boxDownload, boxDownloadLink, btnFloat;
        ...
        var remove = function () {
            if (params.position == 'bottom' || params.position == 'top') {
                ...
                box.animate({height: 0, top: goTo}, animationSpeed, '', function () {
                    createAudio('');
                    stop();
                    box.remove();
                });
            } else {
                box.animate({opacity: 0}, animationSpeed, '', function () {
                    createAudio('');
                    stop();
                    box.remove();
                });
        ...
        var show = function () {
            if (params.position == 'bottom' || params.position == 'top') {
                ...
                btnFloat.animate({top: goTo - btnFloat.height()}, animationSpeed);
                box.animate({
                    height: boxHeightRemember + (box.innerHeight() - box.height()) + (box.outerHeight() - box.innerHeight()),
                    top: goTo
        ...
        $(window).on('resize', function () {
            if (params.position == 'bottom' || params.position == 'top') {
                ...
                btnFloat.css({
                    opacity: 1,
                    left: $(window).width() - btnFloat.width() - 30,
                    top: $(window).height() - box.height() - btnFloat.height()
                });
                barProgressSize();
            }
        });
